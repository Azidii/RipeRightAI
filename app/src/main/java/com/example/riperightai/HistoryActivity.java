...
public class HistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnClearAll.setOnClickListener(v -> {
            new AlertDialog.Builder(this)
                    ...
                    .setMessage("This will permanently delete all your scan history.")
    ...
    /** Bulk delete functionality for Clear All button */
        ...
        db.collection("scan_history").whereEqualTo("deviceId", deviceId).get()
                .addOnSuccessListener(snap -> {
                    ...
                    batch.commit().addOnSuccessListener(aVoid ->
                            Toast.makeText(this, "All history cleared successfully", Toast.LENGTH_SHORT).show()
